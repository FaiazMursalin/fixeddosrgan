...
def plot_training_curves(history, save_path='training_curves_optimized_x2.png'):
...
def save_results(history, metrics, save_path='training_curves_optimized_x2.txt'):
