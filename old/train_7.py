...
from utils_3 import SRDataset, evaluate_model, save_results
from old.model_7 import ImprovedGenerator, ContentLoss, TVLoss
...
def train_model(generator, train_loader, val_loader, test_set5_loader, test_set14_loader, num_epochs, device):
    ...
    model_save_path = 'old/model_7.pth'
    best_model_path = 'old/best_model_7.pth'
    best_psnr = 0
    ...
    for epoch in range(num_epochs):
        ...
        for lr_imgs, hr_imgs in progress_bar:
            ...
            if epoch > warmup_epochs:  # Start augmentation after warmup
...
if __name__ == "__main__":
    ...
    # Initialize model
    generator = ImprovedGenerator(scale_factor=scale_factor).to(device)
