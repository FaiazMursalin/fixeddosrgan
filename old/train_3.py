...
from old.models_3 import ImprovedSRCNN, Discriminator, ContentLoss
...
def train_gan_model(generator, discriminator, train_loader, val_loader, test_set5_loader, test_set14_loader, num_epochs,
    ...
    for epoch in range(num_epochs):
        ...
        for lr_imgs, hr_imgs in progress_bar:
            ...
            g_loss = content_loss + 0.00005 * adversarial_loss
...
def save_training_history(history, filename='training_history_3.txt'):
...
if __name__ == "__main__":
    ...
    batch_size = 16
    num_epochs = 1000  # Increased from 300
